...
import { posterUrl, tvHref } from "@/lib/tmdb";
...
export const getServerSideProps: GetServerSideProps<MyTVShowsProps> = withAuth(
  async (context, _userId) => {
  ...
  return (
    <Layout user={user}>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 pt-24 pb-16">
        ...
        <p className="text-text-secondary mb-10">TV shows you&apos;ve liked</p>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-text-secondary text-lg">No liked TV shows yet</p>
            <Link
              href="/tv-shows"
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
            {likes.map((like) => {
              const href = tvHref({ id: like.media_id, name: like.title });
              return (
